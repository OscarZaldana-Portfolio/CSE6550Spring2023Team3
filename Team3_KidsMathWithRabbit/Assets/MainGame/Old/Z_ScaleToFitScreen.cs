...
/*
 This script is made to make sure that the background picture is resized to the canvas size for different phones.
 */
public class Z_ScaleToFitScreen : MonoBehaviour
{
